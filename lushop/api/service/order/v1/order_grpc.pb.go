...
const (
	Order_CartItemList_FullMethodName      = "/order.v1.Order/CartItemList"
	Order_CreateCartItem_FullMethodName    = "/order.v1.Order/CreateCartItem"
	Order_UpdateCartItem_FullMethodName    = "/order.v1.Order/UpdateCartItem"
	Order_DeleteCartItem_FullMethodName    = "/order.v1.Order/DeleteCartItem"
	Order_CreateOrder_FullMethodName       = "/order.v1.Order/CreateOrder"
	Order_OrderList_FullMethodName         = "/order.v1.Order/OrderList"
	Order_OrderDetail_FullMethodName       = "/order.v1.Order/OrderDetail"
