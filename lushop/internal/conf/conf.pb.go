...
type Server_RateLimit struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Enabled       bool                         `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`                           // 是否启用 Sentinel 限流
	Whitelist     []string                     `protobuf:"bytes,2,rep,name=whitelist,proto3" json:"whitelist,omitempty"`                        // 白名单端点（不限流）
	FlowRules     []*Server_FlowRule           `protobuf:"bytes,3,rep,name=flow_rules,json=flowRules,proto3" json:"flow_rules,omitempty"`       // Sentinel 限流规则
	CbRules       []*Server_CircuitBreakerRule `protobuf:"bytes,4,rep,name=cb_rules,json=cbRules,proto3" json:"cb_rules,omitempty"`             // Sentinel 熔断规则（可选）
	SystemRules   []*Server_SystemRule         `protobuf:"bytes,5,rep,name=system_rules,json=systemRules,proto3" json:"system_rules,omitempty"` // Sentinel 系统规则（可选）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_RateLimit) GetFlowRules() []*Server_FlowRule {
	if x != nil {
		return x.FlowRules
	}
	return nil
...
func (x *Server_RateLimit) GetCbRules() []*Server_CircuitBreakerRule {
	if x != nil {
		return x.CbRules
	}
	return nil
...
func (x *Server_RateLimit) GetSystemRules() []*Server_SystemRule {
	if x != nil {
...
type Server_FlowRule struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Resource        string                 `protobuf:"bytes,1,opt,name=resource,proto3" json:"resource,omitempty"`                                       // 资源名（接口路径）
	Threshold       float64                `protobuf:"fixed64,2,opt,name=threshold,proto3" json:"threshold,omitempty"`                                   // 阈值（QPS）
	StatIntervalMs  uint32                 `protobuf:"varint,3,opt,name=stat_interval_ms,json=statIntervalMs,proto3" json:"stat_interval_ms,omitempty"`  // 统计间隔（毫秒），默认1000
	ControlBehavior int32                  `protobuf:"varint,4,opt,name=control_behavior,json=controlBehavior,proto3" json:"control_behavior,omitempty"` // 控制行为（0:Reject直接拒绝, 1:Throttling匀速排队）
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *Server_FlowRule) Reset() {
	*x = Server_FlowRule{}
...
func (x *Server_FlowRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_FlowRule) ProtoMessage() {}

func (x *Server_FlowRule) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_FlowRule.ProtoReflect.Descriptor instead.
func (*Server_FlowRule) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 3}
}

func (x *Server_FlowRule) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
func (x *Server_FlowRule) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *Server_FlowRule) GetStatIntervalMs() uint32 {
	if x != nil {
...
func (x *Server_FlowRule) GetControlBehavior() int32 {
	if x != nil {
...
type Server_CircuitBreakerRule struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Resource         string                 `protobuf:"bytes,1,opt,name=resource,proto3" json:"resource,omitempty"`                                            // 资源名（接口路径）
	Strategy         string                 `protobuf:"bytes,2,opt,name=strategy,proto3" json:"strategy,omitempty"`                                            // 策略（SlowRequestRatio慢调用比例/ErrorRatio错误率/ErrorCount错误数）
	RetryTimeoutMs   uint32                 `protobuf:"varint,3,opt,name=retry_timeout_ms,json=retryTimeoutMs,proto3" json:"retry_timeout_ms,omitempty"`       // 重试超时时间（毫秒）
	MinRequestAmount uint64                 `protobuf:"varint,4,opt,name=min_request_amount,json=minRequestAmount,proto3" json:"min_request_amount,omitempty"` // 最小请求数
	StatIntervalMs   uint32                 `protobuf:"varint,5,opt,name=stat_interval_ms,json=statIntervalMs,proto3" json:"stat_interval_ms,omitempty"`       // 统计间隔（毫秒）
	MaxAllowedRtMs   uint64                 `protobuf:"varint,6,opt,name=max_allowed_rt_ms,json=maxAllowedRtMs,proto3" json:"max_allowed_rt_ms,omitempty"`     // 最大允许响应时间（毫秒），仅用于SlowRequestRatio
	Threshold        float64                `protobuf:"fixed64,7,opt,name=threshold,proto3" json:"threshold,omitempty"`                                        // 阈值（比例或数量）
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *Server_CircuitBreakerRule) Reset() {
	*x = Server_CircuitBreakerRule{}
	mi := &file_conf_conf_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Server_CircuitBreakerRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_CircuitBreakerRule) ProtoMessage() {}

func (x *Server_CircuitBreakerRule) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_CircuitBreakerRule.ProtoReflect.Descriptor instead.
func (*Server_CircuitBreakerRule) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 4}
}

func (x *Server_CircuitBreakerRule) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
func (x *Server_CircuitBreakerRule) GetStrategy() string {
	if x != nil {
		return x.Strategy
	}
	return ""
...
func (x *Server_CircuitBreakerRule) GetRetryTimeoutMs() uint32 {
	if x != nil {
...
func (x *Server_CircuitBreakerRule) GetMinRequestAmount() uint64 {
	if x != nil {
...
func (x *Server_CircuitBreakerRule) GetStatIntervalMs() uint32 {
	if x != nil {
		return x.StatIntervalMs
	}
	return 0
...
func (x *Server_CircuitBreakerRule) GetMaxAllowedRtMs() uint64 {
	if x != nil {
...
func (x *Server_CircuitBreakerRule) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
type Server_SystemRule struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MetricType    int32                  `protobuf:"varint,1,opt,name=metric_type,json=metricType,proto3" json:"metric_type,omitempty"`        // 指标类型（0:Load系统负载, 1:AvgRT平均响应时间, 2:Concurrency并发数, 3:InboundQPS入口QPS, 4:CpuUsage CPU使用率）
	TriggerCount  float64                `protobuf:"fixed64,2,opt,name=trigger_count,json=triggerCount,proto3" json:"trigger_count,omitempty"` // 触发阈值
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Server_SystemRule) Reset() {
	*x = Server_SystemRule{}
...
func (x *Server_SystemRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_SystemRule) ProtoMessage() {}

func (x *Server_SystemRule) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_SystemRule.ProtoReflect.Descriptor instead.
func (*Server_SystemRule) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 5}
}

func (x *Server_SystemRule) GetMetricType() int32 {
	if x != nil {
		return x.MetricType
	}
	return 0
...
func (x *Server_SystemRule) GetTriggerCount() float64 {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05authz\x18\t \x01(\v2\x11.lushop.api.AuthzR\x05authz\"\x86\t\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1a\x83\x02\n" +
	"\tRateLimit\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1c\n" +
	"\twhitelist\x18\x02 \x03(\tR\twhitelist\x12:\n" +
	"\n" +
	"flow_rules\x18\x03 \x03(\v2\x1b.lushop.api.Server.FlowRuleR\tflowRules\x12@\n" +
	"\bcb_rules\x18\x04 \x03(\v2%.lushop.api.Server.CircuitBreakerRuleR\acbRules\x12@\n" +
	"\fsystem_rules\x18\x05 \x03(\v2\x1d.lushop.api.Server.SystemRuleR\vsystemRules\x1a\x99\x01\n" +
	"\bFlowRule\x12\x1a\n" +
	"\bresource\x18\x01 \x01(\tR\bresource\x12\x1c\n" +
	"\tthreshold\x18\x02 \x01(\x01R\tthreshold\x12(\n" +
	"\x10stat_interval_ms\x18\x03 \x01(\rR\x0estatIntervalMs\x12)\n" +
	"\x10control_behavior\x18\x04 \x01(\x05R\x0fcontrolBehavior\x1a\x97\x02\n" +
	"\x12CircuitBreakerRule\x12\x1a\n" +
	"\bresource\x18\x01 \x01(\tR\bresource\x12\x1a\n" +
	"\bstrategy\x18\x02 \x01(\tR\bstrategy\x12(\n" +
	"\x10retry_timeout_ms\x18\x03 \x01(\rR\x0eretryTimeoutMs\x12,\n" +
	"\x12min_request_amount\x18\x04 \x01(\x04R\x10minRequestAmount\x12(\n" +
	"\x10stat_interval_ms\x18\x05 \x01(\rR\x0estatIntervalMs\x12)\n" +
	"\x11max_allowed_rt_ms\x18\x06 \x01(\x04R\x0emaxAllowedRtMs\x12\x1c\n" +
	"\tthreshold\x18\a \x01(\x01R\tthreshold\x1aR\n" +
	"\n" +
	"SystemRule\x12\x1f\n" +
	"\vmetric_type\x18\x01 \x01(\x05R\n" +
	"metricType\x12#\n" +
	"\rtrigger_count\x18\x02 \x01(\x01R\ftriggerCount\"\xc7\x03\n" +
	"\x04Data\x125\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_FlowRule)(nil),           // 15: lushop.api.Server.FlowRule
	(*Server_CircuitBreakerRule)(nil), // 16: lushop.api.Server.CircuitBreakerRule
	(*Server_SystemRule)(nil),         // 17: lushop.api.Server.SystemRule
	(*Data_Database)(nil),             // 18: lushop.api.Data.Database
	(*Data_Redis)(nil),                // 19: lushop.api.Data.Redis
	(*Service_User)(nil),              // 20: lushop.api.Service.User
	(*Service_Goods)(nil),             // 21: lushop.api.Service.Goods
	(*Service_UserAuth)(nil),          // 22: lushop.api.Service.UserAuth
	(*Service_Order)(nil),             // 23: lushop.api.Service.Order
	(*Service_Inventory)(nil),         // 24: lushop.api.Service.Inventory
	(*Service_UserOp)(nil),            // 25: lushop.api.Service.UserOp
	(*Registry_Consul)(nil),           // 26: lushop.api.Registry.Consul
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	18, // 11: lushop.api.Data.database:type_name -> lushop.api.Data.Database
	19, // 12: lushop.api.Data.redis:type_name -> lushop.api.Data.Redis
	20, // 13: lushop.api.Service.user:type_name -> lushop.api.Service.User
	21, // 14: lushop.api.Service.goods:type_name -> lushop.api.Service.Goods
	22, // 15: lushop.api.Service.user_auth:type_name -> lushop.api.Service.UserAuth
	23, // 16: lushop.api.Service.order:type_name -> lushop.api.Service.Order
	24, // 17: lushop.api.Service.inventory:type_name -> lushop.api.Service.Inventory
	25, // 18: lushop.api.Service.userop:type_name -> lushop.api.Service.UserOp
	26, // 19: lushop.api.Registry.consul:type_name -> lushop.api.Registry.Consul
	10, // 20: lushop.api.Task.items:type_name -> lushop.api.TaskItem
	27, // 21: lushop.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	14, // 22: lushop.api.Server.HTTP.rate_limit:type_name -> lushop.api.Server.RateLimit
	27, // 23: lushop.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	15, // 24: lushop.api.Server.RateLimit.flow_rules:type_name -> lushop.api.Server.FlowRule
	16, // 25: lushop.api.Server.RateLimit.cb_rules:type_name -> lushop.api.Server.CircuitBreakerRule
	17, // 26: lushop.api.Server.RateLimit.system_rules:type_name -> lushop.api.Server.SystemRule
	27, // 27: lushop.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	27, // 28: lushop.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	27, // 29: lushop.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
